package ma.itroad.ram.tat.scheduler.ms.domain;
...
@Entity(name = "netline_flight_message")
public class NetlineFlightMessage implements Serializable {
	...
	public NetlineFlightMessage(Long id, String legNo, String fnCarrier, String fnNumber, String fnSuffix,
		...
		this.delayCode03 = delayCode03;
		this.delayTime03 = delayTime03;
		this.flightUniqueCode = flightUniqueCode;
	}
	...
	public String generateUniqueFlightCode() {
		...
		String s = "" + fnCarrier + fnNumber + "-" + depApSched + "-" + dayOfOrigin;
		flightUniqueCode = s;
		return s;
	}
